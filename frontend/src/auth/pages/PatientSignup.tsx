...
export default function PatientSignup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-blue-50 px-3 sm:px-4 py-6 sm:py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-slate-500 text-xs sm:text-sm mt-1 sm:mt-2">{t('patientSignup.portalLabel')}</p>
        </div>
