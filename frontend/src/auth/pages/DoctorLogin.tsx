    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#fff7ed] via-[#fed7aa] to-[#fb923c] px-4 py-10">
      <div className="w-full max-w-md">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-slate-800 font-bold text-base sm:text-lg mt-1 sm:mt-2">Doctor Portal Login</p>
        </div>

        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-5 sm:p-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 sm:mb-5 text-center">Welcome!</h1>
