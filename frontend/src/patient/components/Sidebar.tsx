...
import { closeSidebar, setDashboardTab, setCurrentPage } from '../store/uiSlice';
      ...
      <aside className={`sidebar-drawer ${isOpen ? 'open' : ''}`} aria-label={tNavbar('openSidebar')}>
        ...
        <div className="sidebar-content">
          ...
          <div className="sidebar-group">
            <span className="sidebar-group-title">{tFooter('mainNavigation', 'MAIN NAVIGATION')}</span>
          ...
          <div className="sidebar-group">
            <span className="sidebar-group-title">{tPatient('patientCareHub', 'PATIENT CARE HUB')}</span>
            <nav className="sidebar-menu">
              <button 
                type="button" 
                ...
                onClick={() => { 
                  dispatch(setCurrentPage('dashboard'));
                  dispatch(setDashboardTab('appointments'));
                  navigate('/patient/dashboard'); 
                  dispatch(closeSidebar()); 
                }}
              >
                ...
                <span>{tPatient('myAppointments', 'My Appointments')}</span>
              </button>
              <button 
                type="button" 
                ...
                onClick={() => { 
                  dispatch(setCurrentPage('dashboard'));
                  dispatch(setDashboardTab('records'));
                  navigate('/patient/dashboard'); 
                  dispatch(closeSidebar()); 
                }}
              >
                ...
                <span>{tPatient('healthRecords', 'Health Records & History')}</span>
              </button>
              <button 
                type="button" 
                ...
                onClick={() => { 
                  dispatch(setCurrentPage('dashboard'));
                  dispatch(setDashboardTab('prescriptions')); 
                  navigate('/patient/dashboard'); 
                  dispatch(closeSidebar()); 
                }}
              >
                ...
                <span>{tPatient('prescriptions', 'Prescriptions & Meds')}</span>
              </button>
            </nav>
          </div>
          ...
          <div className="sidebar-group">
            ...
            <nav className="sidebar-menu">
              <button 
                ...
                onClick={() => { navigate('/patient/mch'); dispatch(closeSidebar()); }}
              >
                <img 
                  src="/MCH Tracking-clean.png?v=6" 
                  alt="MCH Tracking" 
          ...
          {/* Section 4: Portals & Services */}
          <div className="sidebar-group">
            <span className="sidebar-group-title">{tFooter('ourServices', 'PORTALS & SERVICES')}</span>
            <nav className="sidebar-menu">
              <button 
                type="button" 
                className="sidebar-item" 
              ...
              >
                <svg className="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="#166534" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
                  <circle cx="9" cy="7" r="4"></circle>
                  <path d="M22 21v-2a4 4 0 0 0-3-3.87"></path>
                  <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                </svg>
                <span style={{ color: '#166534', fontWeight: 700 }}>ASHA Dashboard</span>
              </button>
              <button
                type="button"
                className="sidebar-item"
                onClick={() => { navigate('/facility/dashboard'); dispatch(closeSidebar()); }}
              >
                <svg className="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="#ca8a04" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span style={{ color: '#ca8a04', fontWeight: 700 }}>Facility Dashboard</span>
              </button>
              <button
                type="button"
                className="sidebar-item"
