...
export default function PaymentTestPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-blue-50 px-3 sm:px-4 py-6 sm:py-8">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-slate-100 p-5 sm:p-8 text-center">
        <h1 className="text-xl font-semibold text-slate-900 mb-2">{t('patient:paymentTestTitle')}</h1>
        <p className="text-xs sm:text-sm text-slate-500 mb-6 break-all">{t('appointment:appointmentTitle')}: e321edc9-6f15-42e9-a640-20ce407e3d86</p>
