              ...
              {sym.isEditing ? (
                ...
                <>
                  ...
                  <div className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 flex items-center gap-1 transition-opacity">
                    <button onClick={() => startEdit(sym)} className="text-gray-400 hover:text-blue-500 p-1.5 min-w-[32px] min-h-[32px] flex items-center justify-center">
                      <Edit2 className="w-4 h-4" />
                    </button>
                    <button onClick={() => removeSymptom(sym.id)} className="text-gray-400 hover:text-red-500 p-1.5 min-w-[32px] min-h-[32px] flex items-center justify-center">
                      <X className="w-4 h-4" />
                    </button>
                  </div>
                </>
